    ...
    A.extend(A.fn, {
        pstrength: function(B) {
            ...
            return this.each(function() {
                ...
                if(B.strength) {
                    A.fn.runPassword(null, C, B, B.strength);
                }
            })
        },
        runPassword: function(D, F, C, nPerc) {
            nPerc = typeof nPerc === 'undefined' ? A.fn.checkPassword(D, C) : nPerc;
            var B = "#" + F + "_bar",
                E = "#" + F + "_text";
            if (nPerc == -200) {
                strColor = "#f00";
